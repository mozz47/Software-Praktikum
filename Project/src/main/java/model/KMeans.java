...
/**
 * The KMeans class is used to perform the K-means clustering algorithm.
 * It takes a list of data points represented as pairs and the number of clusters as input.
 */
public class KMeans {
    private int k;
    ...
    /**
     * Initializes a KMeans object with the specified number of clusters and a list of data points.
     *
     * @param k    the number of clusters
     * @param pairs    the list of data points represented as pairs
     */
    ...
    /**
     * This method returns the clusters generated by the KMeans algorithm.
     *
     * @return A list of clusters, where each cluster is represented as a list of Pair objects.
     */
